...
class MainSmsServiceProvider extends ServiceProvider
{
    /**
    ...
    {
        $this->mergeConfigFrom(__DIR__.'/../config/mainsms.php', 'mainsms');

        // Register the service the package provides.
        $this->app->singleton('mainsms', function ($app) {
            return new MainSms;
        });
    }
    ...
    protected function bootForConsole()
    {
        ...
        $this->publishes([
            __DIR__.'/../config/mainsms.php' => config_path('mainsms.php'),
        ], 'mainsms.config');
